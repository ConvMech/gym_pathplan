...
def train_implicit(env, nb_epochs, nb_epoch_cycles, render_eval, reward_scale, render, actor, critic, classifier,
    ...
    tau=0.01, eval_env=None, callback=None, entropy_coeff=1., pretrained='none'):
